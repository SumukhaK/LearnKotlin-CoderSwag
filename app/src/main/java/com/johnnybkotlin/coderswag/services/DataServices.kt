...
val hats = listOf( Product("Devslopes Graphic Beanie","$18","hat01"),
    ...
    Product("Devslopes Hat white","$21","hat03"),
    Product("Devslopes Hat Snapback","$19","hat04"))

    val hoodies = listOf( Product("Devslopes Hoodie Gray","$28","hoodie01"),
        Product("Devslopes Hoodie Red","$32","hoodie02"),
        Product("Devslopes Gray Hoodie ","$19","hoodie03"),
        Product("Devslopes Hoodie black","$20","hoodie04"))
